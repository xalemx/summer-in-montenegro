...
function getStatus(spots) {
  ...
  if (spots <= 4) return { label: `${spots} spots left`, classes: 'bg-amber-50 text-amber-700 border border-amber-200', dot: 'bg-amber-500', pulse: true, disabled: false };
  return { label: `${spots} spots available`, classes: 'bg-green-50 text-green-700 border border-green-200', dot: 'bg-green-500', pulse: false, disabled: false };
}
