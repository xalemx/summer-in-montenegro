          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-3xl overflow-hidden border border-border shadow-lg bg-card flex flex-col">
              ...
              <div className="flex items-end gap-2 mt-4">
                ...
                <p className="text-muted-foreground text-xs mt-3">Flexible payment options may be available at checkout through Klarna, subject to eligibility and approval. Summer in Montenegro does not provide finance directly.</p>
              </div>
            ...
            <div className="rounded-3xl overflow-hidden border border-primary/20 shadow-xl flex flex-col" style={{ background: 'hsl(155 43% 21%)' }}>
              <div className="px-8 py-8 border-b border-white/10">
                ...
                <p className="text-white/50 text-xs mt-3">Flexible payment options may be available at checkout through Klarna, subject to eligibility and approval. Summer in Montenegro does not provide finance directly.</p>
              </div>
              <div className="px-8 py-6 flex-1">
                <div className="space-y-3">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '4/5' }}>
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="font-heading text-3xl font-bold text-white">Founder</p>
                <p className="text-white/70 text-sm font-medium mt-0.5">Summer in Montenegro</p>
                <p className="text-white/45 text-xs mt-1">Born in Montenegro · Based between UK and Montenegro</p>
              </div>
            </div>
            <div>
