        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-sm mx-auto mb-10">
            <div className="rounded-3xl p-10 border-2 border-primary text-center shadow-xl" style={{ background: 'hsl(155 43% 18%)' }}>
              ...
              <p className="text-white/50 text-xs mt-2">Flexible payment options may be available at checkout through Klarna, subject to eligibility and approval. Summer in Montenegro does not provide finance directly.</p>
            </div>
          </div>
